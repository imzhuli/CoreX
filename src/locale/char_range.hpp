...
X_STATIC_INLINE std::strong_ordering operator<=>(const xCharRange & lhs, const xCharRange & rhs) { return lhs.Start <=> rhs.Start; }

static constexpr inline xCharRange UnicodeIdStart[] = {
	{ 0x41, 0x5a },		  { 0x5f, 0x5f },		{ 0x61, 0x7a },		  { 0xaa, 0xaa },		{ 0xb5, 0xb5 },		  { 0xba, 0xba },		{ 0xc0, 0xd6 },		  { 0xd8, 0xf6 },
	...
	{ 0x3031, 0x3035 },	  { 0x3038, 0x303c },	{ 0x3041, 0x3096 },	  { 0x309b, 0x309f },	{ 0x30a1, 0x30fa },	  { 0x30fc, 0x30ff },	{ 0x3105, 0x312f },	  { 0x3131, 0x318e },
	...
	{ 0x2f800, 0x2fa1d }, { 0x30000, 0x3134a }, /* {0x0, 0x0} */
};

static constexpr xCharRange UnicodeIdContinue[] = {
	...
	{ 0x12c8, 0x12d6 },	  { 0x12d8, 0x1310 },	{ 0x1312, 0x1315 },	  { 0x1318, 0x135a },	{ 0x135d, 0x135f },	  { 0x1369, 0x1369 },	{ 0x1371, 0x1371 },	  { 0x1380, 0x138f },
	...
	{ 0x2b820, 0x2cea1 }, { 0x2ceb0, 0x2ebe0 }, { 0x2f800, 0x2fa1d }, { 0x30000, 0x3134a }, { 0xe0100, 0xe01ef }, /* {0x0, 0x0} */
};
