...
static constexpr const char * LocalRenames[][2] = { { "in", "id" },	 //  Indonesian
													{ "iw", "he" },	 //  Hebrew
...
static constexpr const char * LocaleScripts[][4] = { { "az", "Latn", "", "AZ" },
													 { "az", "Arab", "", "IR" },
													 { "bs", "Latn", "", "BA" },
...
// Additional mapping for outdated, temporary or exceptionally reserved country
// codes. Reference:
...
static const char * RegionNames[][2] = { { "AC", "Ascension Island" },	// Exceptionally reserved.
										 ...
										 { "AL", "Albania" },
										 { "AM", "Armenia" },
										 { "AN", "Netherlands Antilles" },	// Transitionally reserved, divided into
																			// BQ, CW and SX.
										 { "AO", "Angola" },
										 { "AQ", "Antarctica" },
										 { "AR", "Argentina" },
