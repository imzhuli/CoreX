...
#define X_LIKELY(x)         __builtin_expect(!!(bool)(x), 1)
#define X_UNLIKELY(x)       __builtin_expect(!!(bool)(x), 0)
...
#define _X_ANDROID_API__FUNC_NAME_JOIN(PackageName, ClassFuncName) Java_##PackageName##_##ClassFuncName
#define X_ANDROID_API__FUNC_NAME(PackageName, ClassFuncName)       _X_ANDROID_API__FUNC_NAME_JOIN(PackageName, ClassFuncName)
